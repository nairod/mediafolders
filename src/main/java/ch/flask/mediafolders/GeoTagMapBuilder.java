...
//        File path=new File("/mnt/9b305802-2161-4b9e-8d51-752eeaafb346/Medien/Fotos");
//        final String[] acceptedExtensions = new String[] { ".jpg", ".jpeg" };
//
//        // TODO process subdirectories recursively?
//
//        final File[] files = path.listFiles((final File file) -> {
//            if (file.isDirectory())
//                return false;
...
//        });
//
//        Collection<PhotoLocation> photoLocations = new ArrayList<>();
//        for (File file : files)
//        {
